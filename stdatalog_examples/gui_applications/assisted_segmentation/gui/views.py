...
import assisted_segmentation
from assisted_segmentation.gui.Ui_MainWindow import Ui_MainWindow
from assisted_segmentation.gui.Widgets.ComponentWidget import ComponentWidget
from assisted_segmentation.gui.Widgets.dialogs import TagsAlertDialog, WaitingDialog
from assisted_segmentation.gui.ui_controller import UI_Controller
...
class AssistedSegmentationWindow(QMainWindow):
    ...
    def show_app_info(self):
        ...
        info_dialog:QDialog = loader.load(os.path.join(os.path.dirname(assisted_segmentation.__file__),"gui","UI","info_dialog.ui"), self) # Load the info dialog UI
