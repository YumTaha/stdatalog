...
"""
This script, `stdatalog_plot_large.py`, is designed to plot data from acquisition folders
...
def show_help(ctx, param, value):
    if value and not ctx.resilient_parsing:
        ...
        click.secho("   python stdatalog_plot_large.py Acquisition_Folder_Path", fg='cyan')
        # Example: Plot data for a specific sensor
        click.secho("   python stdatalog_plot_large.py Acquisition_Folder_Path -s Sensor_Name", fg='cyan')
        # Example: Plot data with a specific start and end time
        click.secho("   python stdatalog_plot_large.py Acquisition_Folder_Path -st 3 -et 6", fg='cyan')
        # Example: Plot raw data (not multiplied by sensitivity)
        click.secho("   python stdatalog_plot_large.py Acquisition_Folder_Path -r", fg='cyan')
        # Example: Plot data including annotations (if any in the acquisition)
        click.secho("   python stdatalog_plot_large.py Acquisition_Folder_Path -l", fg='cyan')
        # Example: Plot data in subplots (one subplot for each sensor axis)
        click.secho("   python stdatalog_plot_large.py Acquisition_Folder_Path -p", fg='cyan')
        # Example: Save plots as HTML files
        click.secho("   python stdatalog_plot_large.py Acquisition_Folder_Path -sp", fg='cyan')
...
@click.version_option(script_version, '-v', '--version', prog_name="stdatalog_plot_large", is_flag=True, help="stdatalog_plot_large tool version number")
