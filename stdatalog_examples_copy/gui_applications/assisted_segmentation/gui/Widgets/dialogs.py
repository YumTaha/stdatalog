...
class TagsAlertDialog(QDialog):
    def __init__(self, parent=None):
        ...
        main_dialog_widget = loader.load(os.path.join(os.path.dirname(assisted_segmentation.__file__),"gui","UI","tags_alert_dialog.ui"), parent) # Load the UI file
...
class WaitingDialog(QDialog):
    def __init__(self, title, text, parent=None):
        ...
        loading_gif_path = os.path.join(os.path.dirname(assisted_segmentation.__file__),"gui","UI","loading_icon.gif") # Get the path to the loading icon
