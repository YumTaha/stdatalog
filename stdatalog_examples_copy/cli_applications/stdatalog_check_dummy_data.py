...
# coding: utf-8 
# *****************************************************************************
#  * @file    stdatalog_check_dummy_data.py
#  * @author  SRA
# ******************************************************************************
# * @attention
# *
...
"""
This script, `stdatalog_check_dummy_data.py`, is designed to check for dummy data in acquisition folders
...
from stdatalog_core.HSD_utils.exceptions import MissingDeviceModelError, MissingISPUOutputDescriptorException
...
def show_help(ctx, param, value):
    if value and not ctx.resilient_parsing:
        ...
        click.secho("   python stdatalog_check_dummy_data.py Acquisition_Folder_Path", fg='cyan')
        # Example: Check dummy data for a specific sensor by name
        click.secho("   python stdatalog_check_dummy_data.py Acquisition_Folder_Path -s SENSOR_NAME", fg='cyan')
        # Example: Check dummy data starting from a specific time
        click.secho("   python stdatalog_check_dummy_data.py Acquisition_Folder_Path -st 10", fg='cyan')
        # Example: Check dummy data starting from a specific time and ending at a specific time
        click.secho("   python stdatalog_check_dummy_data.py Acquisition_Folder_Path -st 10 -et 20", fg='cyan')
        # Example: Upload a custom Device Template Model (DTDL) "custom_model.json" with board_id=0xff, fw_id=0xff and check dummy data
        click.secho("   python stdatalog_check_dummy_data.py Acquisition_Folder_Path -cdm 255 255 custom_model.json", fg='cyan')
        # Example: Specify the size of each data chunk to be processed
        click.secho("   python stdatalog_check_dummy_data.py Acquisition_Folder_Path -cs 1000", fg='cyan')
...
@click.version_option(script_version, '-v', '--version', prog_name="stdatalog_check_dummy_data", is_flag=True, help="stdatalog_check_dummy_data tool version number")
